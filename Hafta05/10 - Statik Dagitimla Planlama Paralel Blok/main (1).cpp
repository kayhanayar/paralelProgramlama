...
)
{
	...
	{
		uint64_t parcaBoyutu = GUVBOL(m, iplikSayisi);
		uint64_t altSinir = id * parcaBoyutu;
		uint64_t ustSinir = std::min(altSinir + parcaBoyutu, m);
...
int main()
{
	...
	blok_paralel_carpim(A, x, sonucVector, m, n,8);
